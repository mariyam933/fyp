...
const UploadImage = ({ setImage }) => {
  ...
  const { getRootProps, getInputProps, isDragActive } = useDropzone({
    ...
    onDrop, // Triggered when file is dropped
  ...
  return (
    <div className="image-upload mt-2">
      <div
        {...getRootProps()}
        className={`border-dashed text-sm border-2 rounded-lg text-gray-600 ${isDragActive ? "border-blue-500" : "border-blue-400 hover:border-blue-500"} p-7 text-center cursor-pointer`}
      >
        <input {...getInputProps()} />
